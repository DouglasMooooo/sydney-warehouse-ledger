...
export default async function Page() {
  ...
  const [locations,tasks] = process.env.WAREHOUSE_DESIGN_FIXTURE==='true'?[warehouseDesignFixture(),{awaitingPickup:[]}]:[(await adapter.readLocationSummaries()).locations,await adapter.readTodayTasks(businessDate)];
