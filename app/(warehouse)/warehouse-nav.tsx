...
const items = [['/dashboard','工作台',Toolbox],['/work-orders','工单备货',Scan],['/returns','坏机接收',ClockCounterClockwise],['/moves','库存作业',ArrowsLeftRight],['/warehouse-layout','仓库图',Warehouse],['/tasks','作业任务',Package]] as const;
