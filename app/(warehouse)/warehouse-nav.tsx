...
const items = [['/dashboard','工作台',Toolbox],['/work-orders','库存操作台',Scan],['/returns','坏机接收',ClockCounterClockwise],['/warehouse-layout','仓库布局',Warehouse],['/tasks','作业任务',Package]] as const;
