...
export interface BulkApprovalScope {reviewBatchFingerprint:string;filter:{reviewResolution:'READY_FOR_APPROVAL';verificationStatus:'VERIFIED'};candidateFingerprints:string[];candidateCount:number}
...
export interface MigrationApprovalPrincipal {principalType:'HUMAN'|'AI'|'SERVICE';principalId:string;permissions:readonly ('MIGRATION_REVIEW'|'MIGRATION_APPROVE'|'MIGRATION_FREEZE')[]}
